...
### Что такое удаленный репозиторий и для чего он нужен
  Удаленный репозиторий это папка на общедоступном ресурсе, с которым можно  работать удаленно. Он нужен, для того, чтоб организовать коллективную работу при редактировании документа
